...
class ModalComponent(BaseModel):
    def init(self) -> 'ModalComponent':
        return self


# 模拟 drawer.Component
class DrawerComponent(BaseModel):
    def init(self) -> 'DrawerComponent':
        return self
...
class Item(BaseModel):
    ...
    # 弹窗
    def set_modal(self, callback: Callable[[ModalComponent], Any]) -> 'Item':
        component = ModalComponent().init()
        self.modal = callback(component)
        return self

    # 抽屉
    def set_drawer(self, callback: Callable[[DrawerComponent], Any]) -> 'Item':
        component = DrawerComponent().init()
