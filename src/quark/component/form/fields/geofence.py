...
class Component(BaseModel):
    """
    表示地理围栏组件的类，使用 pydantic 定义组件属性和方法。

    Attributes:
        component_key (str): 组件标识。
        component (str): 组件名称，默认为 "geofenceField"。
        ...
        zoom (int): 缩放级别，默认为 14。
        map_key (str): 地图 Key，默认为 "70ac74a1443326e66e51a4255700a4e2"。
        map_security_js_code (str): 地图安全密钥，默认为 "5c4fc57d6cba5efd1c15c988d18d2a78"。
    """
    component_key: str = ""
